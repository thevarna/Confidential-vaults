...
const Dropdown: React.FC<{
	...
	return (
		<DropdownMenu.Root open={dropdownOpen} onOpenChange={setDropdownOpen}>
			<DropdownMenu.Trigger className='w-md px-6 py-4 font-mono text-sm text-white/60 hover:text-white hover:bg-white/5 border-white/5 hover:border-white/50 flex items-center justify-between focus:outline-none'>
